...
function ShowcaseItem() {
  return (
    <Link href="/showcases/1" className="h-[27rem]   cursor-pointer bg-white shadow drop-shadow-md overflow-hidden group hover:bg-blue-200 rounded-lg w-[25rem]  flex flex-col p-3" >
...
<p className="text-gray-400 group-hover:text-white group-hover:font-semibold" > Lorem Ipsum hawhen an unknown printer ley of type and scrambled it to make a  only five centuries, but also the leap</p>
